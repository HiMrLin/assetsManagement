package com.fjnu.assetsManagement.module.loginManagement.enums;

import com.fjnu.assetsManagement.enums.IReasonOfFailure;

public enum LoginManagementReasonOfFailure implements IReasonOfFailure {
    ...
    LoginManagementReasonOfFailure(String en_msg, String zh_msg) {
        this.en_msg = en_msg;
        this.zh_msg = zh_msg;
    }
