...
public enum ResponseHeadEnum {
	...
	PASSWORD_ERROR("5000","密码错误！","Password error"),
	USER_IS_DISABLED("5000","账号已被停用，请联系管理员！","User is disabled"),
	VERIFICATION_CODE_ERROR("5000","验证码错误！","Verification code error"),
	RESPONSEHEAD_NEED_LOGIN_ERROR("4000","未登录或登录失败!","Not logged in or failed to login!"),
	NO_OPERATING_RIGHTS("5000","您没有该操作的权限，请联系管理员！","No operating rights"),
	ILLEGAL_ATTACK("5000","检测到非法字符攻击!已记录该客户端IP","Illegal attack");
